...
export const HELP_ROWS = [
  ...
  ["Tab / Enter", "Accept completion; commands, sessions, IDs, audio paths"],
  ["↑↓ · Esc", "Select completion · close candidates without clearing input"],
  ["Enter / Shift+Enter", "Send message / insert newline"],
  ["Shift+Tab", "Toggle inline images"],
  ["↑ / ↓", "Move draft cursor; scroll history when empty"],
